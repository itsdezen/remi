...
- **Panel layout rule**: Remi always stays pinned to the **top row, top-left corner**, spanning the full width when it's the only thing in that row. Sub-agents live in a **bottom row**, arranged left-to-right.
